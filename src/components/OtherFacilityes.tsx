            ...
            <Wrapper>
                <div className='relative w-full flex flex-col lg:gap-14 md:gap-10 gap-8'>
                    <div className='flex-1 text-center'>
                        <Heading>
                            Our other <span className='!font-open-sans text-primary-color'>Medical Facility</span>
                        </Heading>
                    ...
                    <div className="flex-1 relative grid md:grid-cols-2 grid-cols-1 gap-5">
                        <div className="relative w-full lg:h-full md:h-[400px] h-auto rounded-2xl overflow-hidden">
                            <Image
                        ...
                        <div className='relative w-full lg:h-full h-[400px] flex flex-col gap-5'>
