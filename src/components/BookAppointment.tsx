            ...
            {openForm &&
                ...
                >
                    <div className='w-full relative h-max'>
                        <motion.div className='max-w-xl w-full bg-white md:p-5 p-2.5 rounded-2xl mx-auto relative'
                            key="form"
                        ...
                        >
                            <div className='w-full flex items-center justify-between'>
                                <Image src={'/images/logo/logo-2.svg'} alt='Dr G Nikila Reddy'
                                    width={400} height={100} className='lg:w-[300px] md:w-[250px] w-[200px]'
                                />
                                <button role='button' className='md:w-11 md:h-11 h-9 w-9 rounded-full bg-zinc-900 text-white flex items-center justify-center cursor-pointer' onClick={() => closeForm(false)}>
                                    <X />
                                </button>
                            </div>

                            <form>
                                <div className='w-full relative mt-8 flex flex-col gap-5 text-zinc-700 font-montserrat font-medium text-lg'>
